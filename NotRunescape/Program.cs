...
while (true)
{
    ...
    Console.Write("[1] Log Boss Kill  [2] View Drop Log  [3] View Inventory  [4] Drop Item  [5] Rest at Lumbridge  [6] Top Hits  [7]  Drop Statistics [99] Fight Hill Giant  [0] Exit\nChoice: ");
